...
**편집 중에 기기 전체가 먹통**
인코딩은 CPU 를 100% 씁니다. 폰 프로필(`edit` 은 자동 적용)은 코어 두 개를
남기고 우선순위도 낮춰서 화면이 계속 반응하게 합니다. 그래도 버벅이면:

```
edit --set render.threads=-3 --set render.nice=19
```

코어를 더 남기고 최대한 양보합니다. 대신 편집은 더 오래 걸립니다.
