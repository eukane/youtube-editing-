...
**방법 2 — 폰에서 직접 (설치 5~15분, 메모리를 많이 씀)**

```
bash ~/gameedit/install-subtitles.sh tiny
```

⚠️ RAM 이 4GB 이하면 `tiny` 를 쓰세요. 기본값(`base`)은 모델만 148MB 라
편집 중에 기기가 버티지 못할 수 있습니다. `tiny` 는 75MB 입니다.
